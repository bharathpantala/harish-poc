...
type Product struct {
	LogisticServiceProvider string    `json:"logistic_service_provider"`
	...
	PalletsType             string    `json:"pallet_type"`
	NbrPackagesDelivered    int       `json:"nbr_packages_delivered"`
	Weight                  float32   `json:"weight"`
	GrossWeight             float32   `json:"gross_weight"`
	Volume                  float32   `json:"volume"`
	VolumeOnTruck           float32   `json:"volume_on_truck"`
	TruckRoute              int       `json:"truck_route"`
	DeliveryDate            time.Time `json:"delivery_date"`
	NbrEuroPallets          int       `json:"nbr_euro_pallets"`
	NbrofGitterboxpallets   int       `json:"nbr_of_gitterbox_pallets"`
