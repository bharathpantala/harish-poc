...
class FabricClientRegister {
    ...
    async  RegisterAdmin() {
        try {
            ...
            let response = {};
            const caURL = ccp.certificateAuthorities['ca.wabco.com'].url;
            ...
            const identity = X509WalletMixin.createIdentity('WabcoMSP', enrollment.certificate, enrollment.key.toBytes());
    ...
    async  RegisterUser() {
        try {
            ...
            const userIdentity = X509WalletMixin.createIdentity('WabcoMSP', enrollment.certificate, enrollment.key.toBytes());
